...
def spiltDataForeCast7Days(json_data):
    ...
    for key in json_data:
        ...
        for eachDay in json_data['SevenDaysForecast']:
            for data in eachDay:
                if data == "TempartureLevel" or key == "WeatherDescription":
                    temp += data + " : " + str(eachDay[data]) +"\n"
                elif data == "WeatherDescriptionEn" or data == "WeatherDescriptionEn" or data == "WeatherDescriptionEn" or data == "WeatherDescriptionEn"
                else:
